    ...
    <footer className="bg-[#0f172a] text-slate-300">
      ...
      <div className="md:hidden max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="space-y-2 mb-5 font-poppins">
          ...
          <a href="mailto:ssales@colombopvc.lk" className="flex items-center gap-2 text-sm text-slate-300 hover:text-[#FACC15] transition-colors break-all">
              ...
              <ul className="space-y-4 font-poppins">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@colombopvc.lk" className="text-sm text-slate-300 hover:text-[#FACC15] transition-colors">
                    sales@colombopvc.lk
                    </a>
                  </div>
                </li>
