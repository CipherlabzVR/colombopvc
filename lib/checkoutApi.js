...
/** ECommerceOrderStatus: Queued=1, InProgress=2, Dispatched=3, Delivered=4, Completed=5, Cancelled=6 */
...
/** OrderRefundStatus from backend (NotApplicable=0, Pending=1, Processing=2, Completed=3, Failed=4). */
...
export function parseRefundStatus(raw) {
...
/**
 * Normalize API order status (number 1–6, numeric string, or enum name).
 * @param {*} raw - orderStatus / OrderStatus from API
 * @returns {number} 1–6, or NaN if unrecognized
 */
